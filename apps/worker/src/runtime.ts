export interface Env { DB:D1Database; ASSETS:Fetcher; ATTACHMENTS:R2Bucket; INVITE_CODE?:string; INVITE_CODE_PEPPER?:string; PASSKEY_UNLOCK_KEK?:string; PASSKEY_RP_ID?:string; PASSKEY_ORIGIN?:string; APP_VERSION?:string }
