...
### Download the latest stable release (v1.1.59)

Open [GitHub Release v1.1.59](https://github.com/17sho/pass-vault-v2/releases/tag/v1.1.59) and download the package for your target:

- Cloudflare: `pass-vault-v2-cloudflare-1.1.59.tar.gz` or `.zip`
- Linux: `pass-vault-v2-linux-1.1.59.tar.gz` or `.zip`
