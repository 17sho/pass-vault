...
Current public assets are `pass-vault-v2-cloudflare-2.2.0.tar.gz`, `.zip`, and `SHA256SUMS`. Install Linux from source using its deployment guide. Verify downloads with `SHA256SUMS`.
