...
enum L10nKey: String, CaseIterable {
    ...
    case useAtLeast8, quickUnlockReason, useMasterPassword, quickUnlockFailed, unableOpenVault, attachmentLimits
...
enum L10n {
    ...
    private static let zh: [L10nKey: String] = [
        ...
        .authenticator: "身份验证器", .totpSecret: "TOTP Base32 密钥", .encryptedAttachment: "加密附件", .filename: "文件名", .size: "大小", .attachmentExplanation: "文件存储在经过认证的加密保险库中。单个文件上限 10 MB，总上限 25 MB。", .previewFile: "预览文件", .exportFile: "导出文件", .unableExportAttachment: "无法导出附件。",
        ...
        .useAtLeast8: "请至少使用 8 个字符。", .quickUnlockReason: "解锁密码保险库", .useMasterPassword: "使用主密码", .quickUnlockFailed: "快速解锁失败，请使用主密码。", .unableOpenVault: "无法打开保险库。", .attachmentLimits: "附件大小必须为 1 字节至 10 MB，保险库内附件总量不得超过 25 MB。",
    ...
    private static let en: [L10nKey: String] = [
        ...
        .authenticator: "Authenticator", .totpSecret: "TOTP Base32 secret", .encryptedAttachment: "Encrypted attachment", .filename: "Filename", .size: "Size", .attachmentExplanation: "Stored inside the authenticated encrypted vault payload. Per-file limit 10 MB; total limit 25 MB.", .previewFile: "Preview File", .exportFile: "Export File", .unableExportAttachment: "Unable to export attachment.",
        ...
        .useAtLeast8: "Use at least 8 characters.", .quickUnlockReason: "Unlock Pass Vault", .useMasterPassword: "Use master password", .quickUnlockFailed: "Quick unlock failed. Use your master password.", .unableOpenVault: "Unable to open the vault.", .attachmentLimits: "Attachment must be 1 byte–10 MB and the vault attachment total must stay under 25 MB.",
