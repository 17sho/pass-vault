...
最新稳定版：[**v2.2.1**](https://github.com/17sho/pass-vault-v2/releases/tag/v2.2.1)

当前公开资产为 `pass-vault-v2-cloudflare-2.2.1.tar.gz`、`.zip` 和 `SHA256SUMS`；Linux 请按对应部署指南从源码安装。下载后请校验 `SHA256SUMS`。
