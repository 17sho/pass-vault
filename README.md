...
前往 [GitHub Release v1.1.60](https://github.com/17sho/pass-vault-v2/releases/tag/v1.1.60) 下载对应平台包：

- Cloudflare：`pass-vault-v2-cloudflare-1.1.60.tar.gz`或`.zip`
- Linux：`pass-vault-v2-linux-1.1.60.tar.gz`或`.zip`
