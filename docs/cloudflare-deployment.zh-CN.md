...
> **版本说明：** GitHub `v1.1.70` Cloudflare 制品包含该 tag 截止的完整代码及 `0011`–`0013` R2 生命周期修复。
...
校验必须显示`OK`。该包包含v1.1.70 tag截止的完整Cloudflare代码；升级后仍须核对并应用全部迁移。
