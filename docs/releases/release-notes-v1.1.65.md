...
- 固定并升级 Cloudflare 本地测试/部署工具链，修复 Sharp/libvips 已知高危漏洞；生产运行依赖不变。
...
- Pins and upgrades the local Cloudflare test/deployment toolchain to remediate known high-severity Sharp/libvips vulnerabilities; production runtime dependencies are unchanged.
