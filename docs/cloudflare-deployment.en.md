...
> **Version note:** the Cloudflare archives attached to GitHub Release `v1.1.72` contain the complete code through that tag, including R2 lifecycle migrations `0011`–`0013`.
