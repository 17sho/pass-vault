...
const variants = {
  cloudflare: ['apps/worker/src','apps/worker/migrations','apps/worker/tsconfig.json','apps/admin-worker/src','scripts/deploy-admin.mjs','tests/fixtures.mjs','tests/admin-deploy-guard.test.js','tests/admin-navigation-ui.test.js','tests/auth-entrance.test.js','tests/attachment.test.js','tests/contract.test.js','tests/session-metadata.test.js','tests/worker.test.js','tests/custom-records-contract.test.js','tests/custom-records-migration.test.js','tests/admin-worker.test.js','tests/admin-responsive-ui.test.js','docs/cloudflare-deployment.zh-CN.md','docs/cloudflare-deployment.en.md'],
