...
for (const variant of requestedVariants) {
  ...
  const releasePackage = {
    ...
    scripts: variant === 'cloudflare' ? {
      test: 'node scripts/build.mjs && node --experimental-strip-types --test --test-concurrency=1 tests/admin-deploy-guard.test.js tests/admin-navigation-ui.test.js tests/admin-module-boundaries.test.js tests/auth-entrance.test.js tests/attachment.test.js tests/contract.test.js tests/session-metadata.test.js tests/worker.test.js tests/custom-records-contract.test.js tests/custom-records-migration.test.js tests/admin-worker.test.js tests/admin-responsive-ui.test.js tests/cloudflare-core-module-boundaries.test.js tests/cloudflare-frontend-dead-code.test.js tests/cloudflare-render-performance.test.js tests/cloudflare-safe-utils-boundaries.test.js tests/dialog-ui-module.test.js tests/password-generator-module.test.js tests/production-assets.test.js',
